    ...
    <div className="flex h-full flex-col items-center justify-center gap-4">
      <div className="flex w-4/5 flex-col gap-3 rounded bg-primary p-4 text-text">
        <div className="rounded-md bg-background p-1 text-center text-2xl">
          ...
          <br /> Best Players
          <br />
          <span className="text-xs">click on a player to see the profile</span>
        </div>
        {userProfile ? (
      ...
      <Link
        to="/plinko"
        className="mb-4 flex items-center justify-center gap-4 rounded-lg bg-indigo-700 p-4 text-lg font-bold text-text shadow-md transition-colors hover:bg-indigo-800"
      >
